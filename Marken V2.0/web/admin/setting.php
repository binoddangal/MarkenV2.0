				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Password Change Setting</li>
						</ul><!-- .breadcrumb -->
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" method="POST" role="form" enctype="multipart/form-data">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="password" name="current" id="form-field-1" required placeholder="Current Password" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="col-sm-9">
											<input type="password" name="new" id="form-field-1" required placeholder="New Password" class="col-xs-10 col-sm-5" />
										</div>
									...
									<div class="space-4"></div>
										...
										<div class="col-sm-9">
											<input type="password" name="confirm" id="form-field-1" required placeholder="Confirm Password" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											<button class="btn btn-info" name="changebtn" type="submit">
