...
$subjectId= $_GET['ref'];
$subject = getSubjectById($conn,$subjectId);

if(isset($_POST['savebtn']))
{
	if(updatesubject($conn,$_POST))
	{
		showMsg('Subject Update Successfully.','success');
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" method="POST" role="form">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="subject_name" id="form-field-1" value="<?php echo $subject['subject_name']; ?>" required placeholder="Subject Name" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
										<select class="col-xs-10 col-sm-5" name="semester_id">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Full Marks </label>

										<div class="col-sm-9">
											<input type="text" name="fullMarks" id="form-field-1" value="<?php echo $subject['fullMarks']; ?>" required placeholder="Full Marks" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Pass Marks </label>

										<div class="col-sm-9">
											<input type="text" name="passMarks" id="form-field-1" value="<?php echo $subject['passMarks']; ?>" required placeholder="Pass Marks" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="credit_hrs" id="form-field-1" value="<?php echo $subject['credit_hrs']; ?>" required placeholder="Credit Hours" class="col-xs-10 col-sm-5" />
										</div>
									</div>
