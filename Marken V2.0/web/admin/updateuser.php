...
if(isset($_POST['savebtn']))
{
	if(!empty($_FILES['file']['name']))
 	{
 		$_POST['image'] = uploadFile('uploads',$_FILES['file']);
...
?>
				<div class="main-content">
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" method="POST" role="form" enctype="multipart/form-data">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" value="<?php echo $user['f_name']; ?>" name="f_name" id="form-field-1" required placeholder="First Name" class="col-xs-10 col-sm-5" />
										</div>
									</div>
					...
					<div class="space-4"></div>
						...
						<div class="col-sm-9">
							<img width="300" src="uploads/<?php echo $user['image']; ?>">
						</div>
					</div>
				<?php endif; ?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="col-xs-10 col-sm-5" name="role">
												<option <?php if($user['role']=='superadmin') echo 'selected="selected"'; ?> value="superadmin">Super Admin</option>
									...
									<div class="space-4"></div>
										...
										<div class="col-sm-9">
											<select class="col-xs-10 col-sm-5" name="status">
												...
												<option <?php if($user['status']=='in-active') echo 'selected="selected"'; ?> value="in-active">In-Active</option>
											 </select>
										</div>
									</div>
