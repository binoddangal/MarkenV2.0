								...
								<div class="row">
									...
									<?php displayMsg(); ?>
										...
										<div class="table-responsive">
											<table id="" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<?php echo ucwords($semester['title']); ?>
														</td>
											...
											<a class="green" href="updatesemester.php?ref=<?php echo $semester['id']; ?>">
											<i class="icon-pencil bigger-130"></i>
											</a>

											<a class="red" href="deletesemester.php?ref=<?php echo $semester['id']; ?>" onclick="return confirm('Are You Sure to Delete ???');">
