							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" method="POST" role="form">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="subject_name" id="form-field-1" required placeholder="Subject Name" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="fullMarks" id="form-field-1" required placeholder="Full Marks" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="passMarks" id="form-field-1" required placeholder="Pass Marks" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="credit_hrs" id="form-field-1" required placeholder="Credit Hours" class="col-xs-10 col-sm-5" />
										</div>
									</div>
