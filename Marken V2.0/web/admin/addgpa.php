...
if(isset($_POST['savebtn']))
{
 	...
 	if(insertgpa($conn,$_POST))
 	{
 		showMsg('GPA Created Successfully.','success');
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" method="POST" role="form" enctype="multipart/form-data">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="title" id="form-field-1" required placeholder="Grade" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="space-4"></div>
										...
										<div class="col-sm-9">
											<input type="text" name="max_gpa" id="form-field-1" required placeholder="Maximum GPA" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="space-4"></div>
										...
										<div class="col-sm-9">
											<input type="text" name="min_gpa" id="form-field-1" required placeholder="Minimum GPA" class="col-xs-10 col-sm-5" />
										</div>
									</div>
