					...
					<div class="page-content">
						<div class="page-header">
							<h1>
								...
								<?php if(isset($_SESSION['showMsg']))
									echo $_SESSION['showMsg']; unset($_SESSION['showMsg']); 
								?>
							</h1>
						</div><!-- /.page-header -->
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" method="POST" role="form">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="roll" id="form-field-1" required placeholder="Roll Number" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="student_id" id="form-field-1" required placeholder="Student Id" class="col-xs-10 col-sm-5" />
										</div>
									</div>
