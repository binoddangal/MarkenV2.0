							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" method="POST" role="form">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="f_name" id="form-field-1" value="<?php echo $student['f_name']; ?>" required placeholder="First Name" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="l_name" id="form-field-1" value="<?php echo $student['l_name']; ?>" required placeholder="Last Name" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Roll </label>

										<div class="col-sm-9">
											<input type="text" name="roll" id="form-field-1" value="<?php echo $student['roll']; ?>" required placeholder="Roll Number" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="student_id" id="form-field-1" value="<?php echo $student['student_id']; ?>" required placeholder="Student Id" class="col-xs-10 col-sm-5" />
										</div>
									</div>
