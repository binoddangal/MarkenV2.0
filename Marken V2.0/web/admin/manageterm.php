								...
								<div class="row">
									...
									<?php displayMsg(); ?>
										...
										<div class="table-responsive">
											...
											<a class="green" href="updateterm.php?ref=<?php echo $term['id']; ?>">
											<i class="icon-pencil bigger-130"></i>
											</a>

											<a class="red" href="deleteterm.php?ref=<?php echo $term['id']; ?>" onclick="return confirm('Are You Sure to Delete ???');">
